...
class SubjectService : BaseService() {
    ...
    fun mapToInternalModel(record: Record) = record.into(SubjectRecord::class.java).let {
        it.into(Subject::class.java).copy(
            teacher = userService.mapToUserView(record, it.schoolId!!)
        )
    }
}