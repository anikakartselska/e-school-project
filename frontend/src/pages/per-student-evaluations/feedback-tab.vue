  ...
  <q-page class="q-pa-sm bg-sms">
    <q-card>
      <q-expansion-item v-model="expansionItem[Semester.FIRST]"
                        ...
                        icon="book"
                        label="Първи срок">
        <student-feedbacks-table :evaluations="evaluations" :semester="Semester.FIRST"/>
      </q-expansion-item>
      <q-expansion-item v-model="expansionItem[Semester.SECOND]"
                        header-class="text-primary"
                        icon="book"
                        label="Втори срок">
        <student-feedbacks-table :evaluations="evaluations" :semester="Semester.SECOND"/>
      </q-expansion-item>
      <q-expansion-item v-model="expansionItem[Semester.YEARLY]"
                        header-class="text-primary"
                        icon="book"
                        label="Общ брой забележки за учебната година">
        <student-feedbacks-table :evaluations="evaluations" :semester="Semester.YEARLY"/>
      </q-expansion-item>
    </q-card>
  </q-page>
</template>
...
import StudentFeedbacksTable from "./student-feedbacks-table.vue";
