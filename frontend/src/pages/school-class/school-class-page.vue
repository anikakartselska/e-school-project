          ...
          <div class="row">
            <div class="col-11">
              ...
              <div class="text-h5">
                ...
                <q-btn v-if="currentUserHasAnyRole([SchoolRole.ADMIN])" class="q-mr-xs" color="primary" flat icon="edit"
                       round @click="updateMainTeacher"/>
              </div>
              <q-tabs v-model="tab" dense>
                ...
                <q-route-tab label="Годишни резултати" name="yearly-results" to="yearly-results"/>
              </q-tabs>
            </div>
            <div class="col-12">
