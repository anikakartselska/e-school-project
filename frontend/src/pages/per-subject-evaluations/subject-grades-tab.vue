  ...
  <q-page class="q-pa-sm bg-sms">
    <q-card>
      <q-expansion-item v-model="expansionItem[Semester.FIRST]"
                        ...
                        icon="book"
                        label="Първи срок">
        <student-grades-table :evaluations="evaluations" :semester="Semester.FIRST" :subject="subject"/>
      </q-expansion-item>
      <q-expansion-item v-model="expansionItem[Semester.SECOND]"
                        header-class="text-primary"
                        icon="book"
                        label="Втори срок">
        <student-grades-table :evaluations="evaluations" :semester="Semester.SECOND" :subject="subject"/>
      </q-expansion-item>
      <q-expansion-item v-model="expansionItem[Semester.YEARLY]"
                        header-class="text-primary"
                        icon="book"
                        label="Годишни оценки">
        <student-grades-table :evaluations="evaluations" :semester="Semester.YEARLY" :subject="subject"/>
      </q-expansion-item>
    </q-card>
  </q-page>
</template>
...
import StudentGradesTable from "./subject-grades-table.vue";
