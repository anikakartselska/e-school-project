  ...
  <q-page class="q-pa-sm bg-sms">
    <q-card>
      <q-expansion-item v-model="expansionItem[Semester.FIRST]"
                        ...
                        icon="book"
                        label="Първи срок">
        <student-feedbacks-table :evaluations="evaluations" :lesson="props.lesson" :semester="Semester.FIRST"
                                 :subject="subject"/>
      </q-expansion-item>
      <q-expansion-item v-model="expansionItem[Semester.SECOND]"
                        ...
                        icon="book"
                        label="Втори срок">
        <student-feedbacks-table :evaluations="evaluations" :lesson="props.lesson" :semester="Semester.SECOND"
                                 :subject="subject"/>
      </q-expansion-item>
      <q-expansion-item v-model="expansionItem[Semester.YEARLY]"
        ...
        <student-feedbacks-table :evaluations="evaluations" :lesson="props.lesson" :semester="Semester.YEARLY"
                                 :subject="subject"/>
      </q-expansion-item>
    </q-card>
  </q-page>
...
import StudentFeedbacksTable from "./subject-feedbacks-table.vue";
