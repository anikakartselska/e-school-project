    ...
    <q-card>
      ...
      >
          ...
          <template v-slot:top-right="props">
              ...
              <q-btn class="q-ml-md" color="primary" icon="person_add" outline round @click="addNewUser()">
...
import {User, UserView} from "../../model/User";
import {useRouter} from "vue-router";
import {getAllUsersBySchoolIdAndPeriodId} from "../../services/RequestService";
import {mapUserToUserView} from "../../services/LocalStorageService";
